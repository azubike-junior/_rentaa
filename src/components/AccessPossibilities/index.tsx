  ...
  return (
    <section className="mt-12 lg:flex lg:items-center flex-row-reverse container lg:justify-between mx-auto px-8 xl:h-600">
      ...
      >
        ...
        <img
          className="absolute xxs:w-18 xs:w-18 w-40 z-0 lg:-bottom-96 xl:-bottom-96 -left-28 lg:h-56 xl:h-60"
          src={BottomLeft}
        />
        <img
          className="absolute xxs:w-24 xs:w-24 w-32 h-60 -bottom-1 -right-3 lg:hidden xl:block"
          src={BottomRight}
        />
      ...
      <article className="mt-14">
        ...
        >
          ...
          <span className="text-secondary">possibilties</span>
        </p>
        <p className="xs:w-80 xxs:w-60 xs:text-xs xxs:text-xs leading-6 text-sm md:text-base lg:text-xl text-center lg:text-left w-400 md:w-500 xl:w-600 mx-auto lg:mx-0  font-normal mt-4 lg:mt-10">
