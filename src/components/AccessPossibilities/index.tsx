    ...
    return (
        <section className="mt-12 lg:flex lg:items-center flex-row-reverse container lg:justify-between mx-auto px-8 xl:h-600">
            <figure className='relative xxs:w-64 xs:mx-auto xs:w-72 xs:h-72 w-90 mx-auto xl:w-500 xl:h-600 lg:m-0 md:w-96 md:h-96'>
                <img className='w-full z-10' src={LandingPageImage} />
            ...
            <p className="xs:w-64 font-dm-sans xxs:w-64 xs:text-2xl xxs:text-2xl text-3xl md:text-4xl md:w-80 w-72 text-center lg:text-5xl lg:w-500 lg:text-left mx-auto lg:mx-0 font-medium">Access a <span className='text-secondary'>world</span> of creative <span className='text-secondary'>possibilties</span></p>
