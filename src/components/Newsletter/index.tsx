...
const Newsletter : React.FC = () => {
    return (
        <section className='mt-28 lg:flex lg:container justify-center items-center mx-auto gap-24'>
            <article>
            ...
            <form className="mt-14 flex flex-col items-center px-8 lg:bg-white lg:py-16 lg:px-7 lg:w-full lg:max-w-form">
                <div className="max-w-xs mx-auto flex flex-col w-full lg:max-w-2xl">
                    ...
                    <input id="firstName" className='border-b mt-2 bg-transparent border-black focus:outline-none lg:text-xl '/>
                </div>
                <div className="max-w-xs mx-auto flex flex-col w-full lg:max-w-2xl mt-10 lg:mt-16">
                    ...
                    <input id="lastName" className='border-b mt-2 bg-transparent border-black focus:outline-none lg:text-xl'/>
                </div>
                <div className="max-w-xs mx-auto flex flex-col w-full lg:max-w-2xl mt-10 lg:mt-16">
                    <label htmlFor="emailAddress" className='text-xs lg:text-xl'>Email Address</label>
                    <input id="emailAddress" className='border-b mt-2 bg-transparent border-black focus:outline-none lg:text-xl'/>
                </div>
                <button className='w-full text-white bg-secondary px-14 py-4 rounded-sm mt-11 text-xs'>Subscribe to Our Newsletter</button>
            </form>
        </section>
    )
}
