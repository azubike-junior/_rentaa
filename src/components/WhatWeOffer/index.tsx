...
const WhatWeOffer : React.FC = () => {
    return (
        <div className="w-full snap-start bg-secondary pt-12 lg:py-32 pb-28  mb-28 mt-24 lg:mt-44">
            <div className='w-full grid grid-cols-1 lg:px-4 lg:grid-cols-2 justify-center gap-4'>
                ...
                <div className="text-white max-w-mxl lg:max-w-lg xl:max-w-mxl mx-auto lg:px-0 mt-9 lg:mt-0">
                    ...
                    <article className="max-w-mxl text-xs px-6 lg:px-0 lg:text-base xl:text-21 text-center lg:text-left leading-5 xl:leading-9  flex flex-col gap-10 xl:gap-14">
                        <div>
                            <p>Access a wide range of available gadgets for rent With filter based searches as well as powerful  search  recommendations custom made for you</p>
                        </div>
                        <div>
                            <p>List gadgets at your own price and find prospective  lenders fast. With zero lending costs, insurance cover and an amazing user experience</p>
                        </div>
                        <div>
                            <p>Cost effective, easy and fast rental services on any gadget. Rent to anyone, from anyone, anytime, anywhere</p>
                        </div>
                    </article>
                </div>
            </div>
